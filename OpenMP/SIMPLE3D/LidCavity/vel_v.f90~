...
DO k = 2, lk
  DO j = 2, nj-1
    ...
    DO i = 2, mi
      ...
      Rxi(i)  = alpha*v_o(i,j+1,k)+beta*v_o(i,j-1,k)+kappa*v_o(i,j,k+1)+sigma*v_o(i,j,k-1)+&
           &delta_x*delta_y*delta_z*v_anto(i,j,k)/dt_o+&
...
DO k = 2, lk
  DO i = 2, mi
    ...
    DO j = 2, nj-1
      ...
      Ryj(j)  = alpha*v_o(i+1,j,k)+beta*v_o(i-1,j,k)+kappa*v_o(i,j,k+1)+sigma*v_o(i,j,k-1)+&
           &delta_x*delta_y*delta_z*v_anto(i,j,k)/dt_o+&
...
DO j = 2, nj-1
  DO i = 2, mi
    ...
    DO k = 2, lk
      ...
      Rzk(k)  = alpha*v_o(i+1,j,k)+beta*v_o(i-1,j,k)+kappa*v_o(i,j+1,k)+sigma*v_o(i,j-1,k)+&
           &delta_x*delta_y*delta_z*v_anto(i,j,k)/dt_o+&
